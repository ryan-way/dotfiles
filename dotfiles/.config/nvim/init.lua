...
vim.keymap.set('n', '<leader>-', ':vertical resize -5<CR>', { noremap = true, silent = true })
vim.keymap.set('n', '<leader>0', ':vertical resize 85<CR>', { noremap = true, silent = true })

vim.keymap.set('n', '<c-n>', ':cnext<CR>', { noremap = true })
vim.keymap.set('n', '<c-p>', ':cprev<CR>', { noremap = true })
...
vim.keymap.set('n', '<leader>g',  require('telescope.builtin').git_files, { desc = 'git files' })
